...
# Executa a tela de login antes de abrir o sistema principal
if __name__ == "__main__":
    resultado = subprocess.run([sys.executable, "login.py"])
    sys.exit()  # encerra o script principal após o login.py ser fechado
...
def abrir_gestao_usuarios():
    global frame_grid, entry_busca, filtro_selecionado  # ← Adicione isto
    ...
    btn_criar_usuario = tk.Button(
        ...
        command=lambda: abrir_tela_criar_usuario(buscar_usuarios),
        bg="green",
        fg="white"
    )
